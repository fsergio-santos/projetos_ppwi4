...
public class UsuarioService {
	...
	public Usuario save(Usuario usuario) {
		...
		if(!usuario.getPassword().equals(usuario.getConfirmPassword())) {
			throw new SenhaDiferenteConfirmeSenhaException("A confirmação da Senha está diferente da Senha informada ");
		}
	...
	@Transactional(readOnly = true)
	public Page<Usuario> findAllByName(String name, Pageable pageable) {
