...
public class UsuarioRestController {
    ...
    public Page<UsuarioDTO> findAll(
    	    ...
    	    Pageable pageable = gerarPagina( paginaAtual.orElse(0), pageSize.orElse(5), dir.orElse("asc"), props.orElse("id"));
    ...
    private Pageable gerarPagina(Integer paginaAtual, Integer pageSize, String dir, String props) {
       	return PageRequest.of(paginaAtual, pageSize, getDirecao(dir) , props);
    }
    ...
    private Direction getDirecao(String dir) {
