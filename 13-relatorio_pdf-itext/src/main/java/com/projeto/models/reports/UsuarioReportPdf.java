package com.projeto.models.reports;
...
public class UsuarioReportPdf {
	...
	public PdfPTable createHeader() {
		...
		float[] columnsWiths = new float[]{15f, 50f, 50f};
		...
		column = new PdfPCell(new Phrase("Código"));
		...
		column = new PdfPCell(new Phrase("E-mail"));
		column.setVerticalAlignment(Element.ALIGN_CENTER);
		column.setBorder(PdfPCell.NO_BORDER);
		table.addCell(column);
